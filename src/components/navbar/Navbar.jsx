  ...
  return (
    <div>
      <div className="navbar bg-base-100">
          ...
          <div className="dropdown">
            ...
            >
              {links.map((link, index) => (
                <li key={index} className="active:underline">
                  <a>{link.name}</a>
                </li>
              ))}
              <li>
        ...
        <a
          className="cursor-pointer text-lg font-medium navbar-center text-center"
          href="/"
        >
          MEJIWOO <br />
          미지우
        ...
        <div className="navbar-end gap-4 lg:gap-7">
          ...
          <HiOutlineShoppingBag className="text-2xl font-light cursor-pointer" />
          <CgProfile className="text-2xl font-light cursor-pointer" />
        </div>
      </div>
    </div>
  );
